import GenerateCurrentLocalFiles from '../../../../../src/context/local/localFile/application/GenerateCurrentLocalFiles';
...
describe('GenerateCurrentLocalFiles', () => {
  let SUT: GenerateCurrentLocalFiles;
  ...
  beforeAll(() => {
    ...
    SUT = new GenerateCurrentLocalFiles(repository);
  });
