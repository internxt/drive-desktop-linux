...
import { EnvironmentDocumentUploader } from './EnvironmentDocumentUploader';
...
@Service()
export class EnvironmentDocumentUploaderFactory
  implements DocumentUploaderFactory
{
  ...
  build() {
    ...
    const fn =
      document.size.value >
      EnvironmentDocumentUploaderFactory.MULTIPART_UPLOAD_SIZE_THRESHOLD
